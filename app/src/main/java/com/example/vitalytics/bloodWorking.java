...
//
//public class bloodWorking extends Activity {
...
//
//            if ((SP != 0) && (DP != 0)) {
//                Intent i = new Intent(bloodWorking.this, bloodResult.class);
//                i.putExtra("SP", SP);
//                i.putExtra("DP", DP);
//                i.putExtra("Usr", user);
//                startActivity(i);
...
//        super.onBackPressed();
//        Intent i = new Intent(bloodWorking.this, startVitals.class);
//        i.putExtra("Usr", user);
//        startActivity(i);
//        finish();
//    }
