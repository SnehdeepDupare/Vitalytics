...
public class resultVitals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.result_vital_scan);
        ...
        All.setOnClickListener(v -> {
            ...
            try {
                ...
                Toast.makeText(resultVitals.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(resultVitals.this, dashboard.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
