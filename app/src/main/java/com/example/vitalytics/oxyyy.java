...
import com.example.vitalytics.Math.Fft;

import java.util.ArrayList;
import java.util.concurrent.atomic.AtomicBoolean;

public class oxyyy extends Activity {
...
//                Intent intent = new Intent(oxyyy.this, oxygenStaturation.class);
...
//        });
    ...
    private final Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (o2 != 0) {
                Intent i = new Intent(oxyyy.this, oxygenResult.class);
                i.putExtra("O2R", o2);
                i.putExtra("Usr", user);
                startActivity(i);
                finish();
...
//        log
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(oxyyy.this, startVitals.class);
        i.putExtra("Usr", user);
        startActivity(i);
        finish();
    }
